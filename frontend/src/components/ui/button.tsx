...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground rounded-lg hover:opacity-90",
        ...
        apple: "bg-primary text-primary-foreground rounded-xl hover:opacity-90 font-medium",
        "apple-secondary": "bg-secondary text-secondary-foreground rounded-xl hover:bg-secondary/80 font-medium",
        "apple-ghost": "text-foreground hover:bg-muted rounded-xl font-medium",
      },
      size: {
